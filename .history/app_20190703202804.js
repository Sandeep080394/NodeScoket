      ...
      executeStoredProc('messagesave', data).then(
        res => {
          if (res) {
            ...
            executeStoredProc('', data)
              .then(resChatUserInfo => {
                var message = {
                  to:
                    'eBBCymQ_2r8:APA91bG5xDOwdJ81k7oTH57AX1QILfXN0iq3J9mpxBm3aheUD2wEUjnzrU-gC2dM58vih2Cj4im7ZF8YMzFUHXTwhHncELVB8kYaMfCecKYAVexUDhlIXuTjZLT1Urbi2fFu-1CCu1Kx',
                  // collapse_key: '',

                  notification: {
                    title: 'Chat',
                    body: 'Chat notification is sent. You are offline!!'
                  }
                };
              ...
              .catch(err => {
                console.log('error occured while fetching the info from sql for chat users.');
              });
